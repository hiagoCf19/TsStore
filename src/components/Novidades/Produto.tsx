    ...
    <React.Fragment>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className=" flex justify-center items-center  sm:mt-12">
          <div className="sm:shadow-none shadow-lg shadow-roxo flex justify-center flex-col sm:flex-row mx-4 gap-4 pb-4 sm:m-0 sm:border-none sm:items-center   rounded-[3px]  sm:mx-[200px] overflow-y-hidden">
            <div className="flex-1 w-full">
              <img
                src={image}
                alt={nome}
                className="sm:w-[34.375rem] sm:rounded-[8px] max-h-[20.125rem] w-full "
              />
            </div>
