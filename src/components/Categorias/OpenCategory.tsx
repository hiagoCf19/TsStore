  ...
  return (
    <BackGrad>
      ...
      <section className="flex gap-4 sm:mx-[100px] sm:mt-10 flex-col sm:flex-row pb-4 ">
        ...
        <aside className="border-none sm:border-r sm:border-solid sm:border-roxo sm:p-3 flex sm:flex-col text-[18px] sm:ml-[-20px] sm:gap-4 gap-3 text-[#a7a7a7d7] flex-wrap  sm:justify-start sm:h-[80vh] mx-4">
