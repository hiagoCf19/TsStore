...
export const AllCategorys = ({ propsCategory }: PropsCategory) => {
  ...
  return (
    <React.Fragment>
      ...
      />
      <section className="flex gap-4 sm:mx-[100px] sm:mt-2 flex-col sm:flex-row ">
